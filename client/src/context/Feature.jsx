...
function Feature() {
  ...
  return (
    <section className="max-padd-container my-16 relative overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-[1fr_1fr_1fr_1fr_1fr] gap-6 gap-y-12 items-center rounded-xl relative z-10">
        ...
        <div className="fade-in flex flex-col items-center justify-center p-6 bg-[#FDFCFB] rounded-2xl border border-[#E8E5E2] shadow-sm hover:shadow-md transition-all duration-500 text-center">
        ...
        <div className="fade-in delay-200 flex flex-col items-center justify-center p-6 bg-[#FDFCFB] rounded-2xl border border-[#E8E5E2] shadow-sm hover:shadow-md transition-all duration-500 text-center">
          <h4 className="text-[18px] md:text-[20px] font-semibold tracking-wide text-[#2E2E2E] mb-2">
            Vận Chuyển Thần Tốc
          </h4>
          <p className="text-[14px] text-gray-500 leading-relaxed">
        ...
        <div className="fade-in delay-400 flex flex-col items-center justify-center p-6 bg-[#FDFCFB] rounded-2xl border border-[#E8E5E2] shadow-sm hover:shadow-md transition-all duration-500 text-center">
          <h4 className="text-[18px] md:text-[20px] font-semibold tracking-wide text-[#2E2E2E] mb-2">
            Thanh Toán Bảo Mật
          </h4>
          <p className="text-[14px] text-gray-500 leading-relaxed">
