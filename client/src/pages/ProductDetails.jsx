        ...
        <div className="flex gap-10 flex-col xl:flex-row mt-3 mb-6">
          ...
          <div className="flex-1 px-6 py-5 bg-[#fff3f7] rounded-3xl shadow-[0_8px_20px_rgba(255,182,193,0.25)]">
            ...
            <div className="flex items-center gap-x-4">
              <button className="bg-[#ffb6c1] hover:bg-[#ff9eb3] transition-all text-white font-semibold rounded-full sm:w-1/2 flexCenter gap-x-2 py-2 shadow-md hover:shadow-pink-200">
                Thêm vào giỏ hàng
