      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4 bg-white/70 rounded-3xl p-6 shadow-sm hover:bg-white/80 hover:scale-102 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-200 transition-all duration-300 ease-in-out">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Hỗ trợ đổi trả trong <span className="font-medium">7 ngày</span>.
              Bởi sự hài lòng của bạn là nguồn cảm hứng bất tận của chúng tôi.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4 bg-white/70 rounded-3xl p-6 shadow-sm hover:bg-white/80 hover:scale-102 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-200 transition-all duration-300 ease-in-out">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Giao dịch an toàn với chuẩn bảo mật quốc tế. Cho bạn thảnh thơi
              tận hưởng trọn vẹn hành trình làm đẹp.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4 bg-white/70 rounded-3xl p-6 shadow-sm hover:bg-white/80 hover:scale-102 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-200 transition-all duration-300 ease-in-out">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Mỗi sản phẩm là một món quà được trân trọng, trao đến bạn nhanh
              chóng và vẹn nguyên tinh hoa từ Nhật Bản.
            </p>
          </div>
        </div>
      </div>
