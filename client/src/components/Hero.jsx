            ...
            <div className="bg-[url('/src/assets/bg.png')] bg-cover bg-center bg-no-repeat h-[80vh] sm:h-[90vh] w-full mt-18 rounded-2xl relative">
                <div className='mx-auto max-w-[1440px] px-4 pt-1 sm:pt-8 flex flex-col justify-between h-full'>
                    <div className='max-w-3xl'>
                        ...
                        <p className='text-[13px] pt-2 leading-relaxed italic text-gray-700'>
                        ...
                        <div className='flex'>
                            <Link
                                to={"/collection"}
                                className="bg-secondary text-white text-xs sm:text-sm font-medium tracking-wide px-4 sm:px-6 py-2 sm:py-3 rounded-full flex items-center justify-center gap-x-2 mt-7 group hover:bg-secondary/90 transition-all duration-500 shadow-lg"
                            >
                                ...
                                <img
                                    ...
                                    alt=""
                                    width={30}
                                    className="bg-white rounded-full flexCenter p-2 m-1 group-hover:translate-x-2 transition-transform duration-500 shadow-lg"
                                />
                            </Link>
                        </div>
                    </div>
