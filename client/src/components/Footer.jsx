...
const Footer = () => {
  return (
    <footer className="pt-16 xl:pt-20 w-full text-gray-600 bg-[#FFF8F7]">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-wrap justify-between gap-6 md:gap-8">
          ...
          <div className="max-w-80 flex-1 order-1 md:order-1">
            ...
            <p className="text-sm mt-3 text-gray-500">
              Chăm sóc vẻ đẹp của bạn với nguyên liệu thiên nhiên và phong cách
              Nhật Bản.
            </p>
          ...
          <div className="hidden md:flex flex-col order-3 md:order-2">
            ...
            <ul className="flex flex-col gap-2 text-sm text-gray-600">
              {["Giới thiệu", "Tuyển dụng", "Báo chí", "Blog", "Đối tác"].map(
                (item, i) => (
                  <li key={i}>
                    <a
                      href="#"
                      className="hover:text-black hover:underline hover:decoration-gray-400 transition-all"
                    >
                      {item}
                    </a>
                  </li>
        ...
        <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-5 text-sm text-gray-500">
          <p>
            ...
            . Bản quyền thuộc về HUSTique Beauty.
          </p>
          <ul className="flex items-center gap-4">
            {["Chính sách bảo mật", "Điều khoản", "Sơ đồ website"].map(
              (item, i) => (
                <li key={i}>
                  <a
                    href="#"
