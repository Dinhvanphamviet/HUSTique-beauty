...
const Item = ({ product }) => {
    ...
    return (
        <div className="transition-all duration-300">
            {/* Card container */}
            <div className="overflow-hidden rounded-2xl shadow-sm hover:shadow-md transition-shadow bg-white">
                
                {/* Image */}
                <div
                    onMouseEnter={() => setHovered(true)}
                    onMouseLeave={() => setHovered(false)}
                    className="flex items-center justify-center h-[182px] w-full relative group rounded-t-2xl"
